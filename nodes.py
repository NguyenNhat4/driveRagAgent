...
class LoadFolderNode(Node):
    ...
    """
    def prep(self, shared):
        # We don't need creds_path anymore, get_drive_service handles it
    ...
    def exec(self, folder_id):
        ...
        if not service:
            raise RuntimeError("Could not create Drive Service. Check authentication.")
        ...
        for f in files:
            ...
            try:
                # creds_path is no longer needed
